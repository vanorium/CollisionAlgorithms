...
export const defineCollision = (shapeA, shapeB) => {
    ...
    if(typeOfA == typeOfB){
        ...
        // Polygon-polygon
        if(typeOfA == 'Polygon') {
            const verticesGroupsA = shapeA.getTransformedVerticesGroups()
            const verticesGroupsB = shapeB.getTransformedVerticesGroups()
    ...
    // Polygon-circle or circle-polygon
        ...
        const vertices = isPolygonA ? shapeA.getTransformedVerticesGroups() : shapeB.getTransformedVerticesGroups()
